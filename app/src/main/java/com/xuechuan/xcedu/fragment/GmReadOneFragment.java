...
import com.xuechuan.xcedu.ui.bank.FreedomTestActivity;
import com.xuechuan.xcedu.ui.bank.LiveExamActivity;
 ...
 */
public class GmReadOneFragment extends BaseFragment implements TestObserver, View.OnClickListener, GmEvalueContract.View {
...
//    private AnswerEvaluateAdapter mEvalueAdapter;
    ...
    private LiveExamActivity mLiveExamActivity;
    private WeiNestedScrollView mSmsvOneLayout;
    ...
    private LinearLayout mGmOneRoolLayout;
     ...
     * @return
     */
    public static GmReadOneFragment newInstance(QuestionSqliteVo vo, int postion, String mCouserid) {
...
/*    @Override
    ...
    protected void initCreateView(View view, Bundle savedInstanceState) {
        ...
        if (mQuestionSqliteVo == null) {
            //滑动布局
            mSmsvOneLayout.setVisibility(View.GONE);
            mIvNetEmptyContent.setVisibility(View.VISIBLE);
            return;
        } else {
            //滑动布局
            mSmsvOneLayout.setVisibility(View.VISIBLE);
...
//        mEvalueAdapter = new AnswerEvaluateAdapter(mContext, mArray);
        ...
        mSmsvOneLayout.setmSmartScrollChangedListener(new WeiNestedScrollView.ISmartScrollChangedListener() {
            @Override
    ...
    private void initView(View view) {
        ...
        mSmsvOneLayout = (WeiNestedScrollView) view.findViewById(R.id.smsv_one_layout);
        mSmsvOneLayout.setOnClickListener(this);
        ...
        mGmOneRoolLayout = (LinearLayout) view.findViewById(R.id.gm_one_rool_layout);
        mGmOneRoolLayout.setOnClickListener(this);
    }
    ...
    public void refresh() {
        ...
        if (mLiveExamActivity != null) {
            mLiveExamActivity.changerColor(mGmReadColorManger);
        }
        initDoEvent();
    ...
    private void registerOberovce() {
        ...
        if (getActivity() instanceof LiveExamActivity) {//模拟考试
            mLiveExamActivity = (LiveExamActivity) getActivity();
        }
...
//                            mSubsciber.notifyChanger();
    ...
    private void doSaveEvent(DoBankSqliteVo vo) {
        ...
        if (mLiveExamActivity != null) {
            mLiveExamActivity.saveUserDoLog(vo);
        }
